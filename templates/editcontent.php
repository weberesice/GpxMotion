...
<div class="sidebar-pane active" id="ho">
    ...
    ?>
        ...
        <button id="viewButton"><i class="fa fa-eye"></i> <?php p($l->t('Load and view animation file'));?></button>
        <button id="loadButton"><i class="fa fa-folder-open-o"></i> <?php p($l->t('Load and edit animation file'));?></button>
    </div>
